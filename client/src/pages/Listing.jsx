...
import 'node_modules/swiper/swiper-bundle.css'; // Ensure this path is correct
      ...
      {listing && !loading && !error && (
        <div>
          ...
          <div className='m-4 max-w-4xl mx-auto'>
            ...
            <p className='flex items-center gap-2 text-slate-700 my-2 text-sm p-4'>
              <FaMapMarkerAlt className='text-green-700' /> {listing.address}
            </p>
            <div className='flex gap-4 p-4'>
              <p className='text-center bg-red-900 rounded-md p-1 text-white w-[90px] sm:w-[200px]'>
                {listing.type === 'rent' ? 'For rent' : 'For Sale'}
              </p>
              {listing.offer && (
                <p className='text-center bg-green-900 rounded-md p-1 text-white w-[100px] sm:w-[200px]'>
            ...
            <div className='p-3'>
              ...
              {currentUser && listing.userRef !== currentUser._id && !contact && (
                <button
                  ...
                  className='bg-slate-700 text-white p-3 rounded-lg w-[300px] sm:w-[900px] ml-6 sm:ml-0 hover:opacity-95 uppercase mt-4'
                >
                  Contact Landlord
                </button>
              )}
